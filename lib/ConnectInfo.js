...
const TradeMiningService_1 = require("./service/TradeMiningService");
...
class ConnectInfo {
    ...
    tradeMining() {
        return this.create(TradeMiningService_1.TradeMiningService);
    }
    bonus() {
    ...
    getScan() {
        return this.isArbi() ? this.addressInfo.arbiScan : this.addressInfo.scan;
    }
    isArbi() {
