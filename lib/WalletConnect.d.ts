...
export declare class ExtWallet {
    provider: providers.JsonRpcProvider;
    address: string;
}
...
export type WalletType = Web3Wallet | PrivateWallet | providers.Web3Provider | {
    provider: any;
};
export type ChainName = 'Arbitrum' | 'Arbitrum Testnet' | 'rinkeby' | 'mainnet' | 'goerli';
