...
let TradeMiningService = class TradeMiningService extends BaseService_1.BaseService {
    ...
    async liquidityInfo() {
        ...
        tradeMiningLiquidity.addLiquidity = (lpTokenAmount, deadline) => {
            ...
            return instantSwap.addLiquidity(this.addressInfo.banana, this.addressInfo.usdc, tool_1.MAXIMUM_U256, tool_1.MAXIMUM_U256, new bignumber_js_1.default(lpTokenAmount).multipliedBy(10 ** lpBalance.decimals).toFixed(0, bignumber_js_1.default.ROUND_DOWN), tool_1.MathTool.deadline(deadline));
        };
        ...
        tradeMiningLiquidity.removeLiquidity = (lpTokenAmount, deadline) => {
            ...
            const instantSwap = this.connectInfo.create(abi_1.ITWAMMInstantSwap);
            return instantSwap.withdrawLiquidity(this.addressInfo.banana, this.addressInfo.usdc, '0', '0', new bignumber_js_1.default(lpTokenAmount).multipliedBy(10 ** lpBalance.decimals).toFixed(0, bignumber_js_1.default.ROUND_DOWN), tool_1.MathTool.deadline(deadline));
        };
