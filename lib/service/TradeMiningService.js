...
let TradeMiningService = class TradeMiningService extends BaseService_1.BaseService {
    ...
    async prizePool() {
        ...
        const [[bananaBalance, lpBalance], executeVirtualOrdersResult, { bananaApexRateLogs }] = await Promise.all([
            ...
            (0, api_1.executeVirtualOrders)(this.connectInfo),
        ...
        const lpTokenValue = new bignumber_js_1.default(lpBalance.balance)
        ...
        ;
        tradeMiningPrizePool.price = new bignumber_js_1.default(usdcReserves).div(1e6).div(new bignumber_js_1.default(bananaReserves).div(1e18)).toFixed();
        ;
    ...
    async swapBalance() {
        const user = this.connectInfo.account;
        const [[bananaResult, usdcResult], { rate, bananaPrice, totalSpents, boostUpRates, kline, bananaBurns }] = await Promise.all([
    ...
    async liquidityInfo() {
        ...
        tradeMiningLiquidity.bananaBalance = new bignumber_js_1.default(bananaBalance.balance)
            .div(10 ** bananaBalance.decimals)
            .toFixed();
        tradeMiningLiquidity.showBananaApprove =
            new bignumber_js_1.default(new bignumber_js_1.default(bananaBalance.allowance).div(10 ** bananaBalance.decimals)).comparedTo('100000000') <=
                0;
        tradeMiningLiquidity.usdcBalance = new bignumber_js_1.default(usdcBalance.balance).div(10 ** usdcBalance.decimals).toFixed();
        tradeMiningLiquidity.showUsdcApprove =
            new bignumber_js_1.default(new bignumber_js_1.default(usdcBalance.allowance).div(10 ** usdcBalance.decimals)).comparedTo('100000000') <= 0;
        tradeMiningLiquidity.lpBalance = new bignumber_js_1.default(lpBalance.balance).div(10 ** lpBalance.decimals).toFixed();
        tradeMiningLiquidity.showLpApprove =
            new bignumber_js_1.default(new bignumber_js_1.default(lpBalance.allowance).div(10 ** lpBalance.decimals)).comparedTo('100000000') <= 0;
        ...
        tradeMiningLiquidity.preAddLiquidity = async (inputToken, inputTokenAmount) => {
            ...
            const lpTokenValue = bignumber_js_1.default.min(new bignumber_js_1.default(bananaValue).multipliedBy(totalSupply).div(bananaReserves).dp(0, bignumber_js_1.default.ROUND_DOWN), new bignumber_js_1.default(usdcValue).multipliedBy(totalSupply).div(usdcReserves).dp(0, bignumber_js_1.default.ROUND_DOWN)).toFixed();
            const lpTokenAmount = new bignumber_js_1.default(lpTokenValue).div(10 ** lpBalance.decimals).toFixed();
            const shareOfPool = new bignumber_js_1.default(lpTokenValue).div(new bignumber_js_1.default(totalSupply).plus(lpTokenValue)).multipliedBy('100').toFixed();
            return {
                banana: bananaAmount,
                usdc: usdcAmount,
        ...
        tradeMiningLiquidity.addLiquidity = (lpTokenAmount, deadline) => {
            ...
            return instantSwap.addLiquidity(this.addressInfo.banana, this.addressInfo.usdc, new bignumber_js_1.default(lpTokenAmount).multipliedBy(10 ** lpBalance.decimals).toFixed(0, bignumber_js_1.default.ROUND_DOWN), tool_1.MathTool.deadline(deadline));
        };
        ...
        tradeMiningLiquidity.removeLiquidity = (lpTokenAmount, deadline) => {
            ...
            const instantSwap = this.connectInfo.create(abi_1.ITWAMMInstantSwap);
            return instantSwap.withdrawLiquidity(this.addressInfo.banana, this.addressInfo.usdc, new bignumber_js_1.default(lpTokenAmount).multipliedBy(10 ** lpBalance.decimals).toFixed(0, bignumber_js_1.default.ROUND_DOWN), tool_1.MathTool.deadline(deadline));
        };
