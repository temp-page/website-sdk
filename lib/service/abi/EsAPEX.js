...
let EsAPEX = class EsAPEX extends BaseService_1.BaseService {
    constructor(connectInfo) {
        super(connectInfo);
        this.esApexInstance = new mulcall_1.MulContract(connectInfo.addressInfo.esApex, abi_1.IEsAPEX2);
        this.esApexContract = new ethers_1.Contract(connectInfo.addressInfo.esApex, abi_1.IEsAPEX2, connectInfo.getWalletOrProvider());
    }
    async vest(amount) {
...
], EsAPEX.prototype, "vest", null);
__decorate([
    (0, tool_1.EnableLogs)(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Array, Array]),
    __metadata("design:returntype", Promise)
], EsAPEX.prototype, "batchWithdraw", null);
__decorate([
    (0, tool_1.EnableLogs)(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Array]),
    __metadata("design:returntype", Promise)
], EsAPEX.prototype, "batchForceWithdraw", null);
EsAPEX = __decorate([
    (0, tool_1.CacheKey)('EsAPEX'),
    __metadata("design:paramtypes", [ConnectInfo_1.ConnectInfo])
], EsAPEX);
exports.EsAPEX = EsAPEX;
