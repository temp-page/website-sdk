...
let IApexClaimable = class IApexClaimable extends BaseService_1.BaseService {
    constructor(connectInfo) {
        super(connectInfo);
        this.apexClaimableInstance = new mulcall_1.MulContract(connectInfo.addressInfo.apexClaimable, abi_1.ApexClaimable);
        this.apexClaimableContract = new ethers_1.Contract(connectInfo.addressInfo.apexClaimable, abi_1.ApexClaimable, connectInfo.getWalletOrProvider());
    }
...
], IApexClaimable.prototype, "claim", null);
