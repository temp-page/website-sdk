...
let MerkleDistributor = class MerkleDistributor extends BaseService_1.BaseService {
    ...
    async claim(index, account, amount, merkleProof) {
        ...
        return this.connectInfo
            .tx()
            .sendContractTransaction(this.merkleDistributorContract, "claim", args, {});
    }
    ...
    async init(user, token, data) {
        ...
        merkleTreeResult.showAmount = new bignumber_js_1.BigNumber(self[2]).div(10 ** tokenInfo.decimal).toFixed(tokenInfo.decimal, bignumber_js_1.BigNumber.ROUND_DOWN);
