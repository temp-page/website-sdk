...
let IApexPool3 = class IApexPool3 extends BaseService_1.BaseService {
    constructor(connectInfo) {
        ...
        const address = connectInfo.isArbi()
            ? connectInfo.addressInfo.apexRegularStaking.arbi.apexPoolV3
            : connectInfo.isMantle()
                ? connectInfo.addressInfo.apexRegularStaking.mantle.apexPoolV3
                : connectInfo.addressInfo.apexRegularStaking.common.apexPoolV3;
