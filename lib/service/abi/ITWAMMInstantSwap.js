...
let ITWAMMInstantSwap = class ITWAMMInstantSwap extends BaseService_1.BaseService {
    ...
    async addLiquidity(token0, token1, lpTokenAmount, amountInOMax, amountIn1Max, deadline) {
        const args = Array.from(arguments);
        return await this.connectInfo.tx().sendContractTransaction(this.TWAMMInstantSwapContract, 'addLiquidity', args, {});
    }
    async withdrawLiquidity(token0, token1, lpTokenAmount, amountOut0Min, amountOut1Min, deadline) {
        const args = Array.from(arguments);
        return await this.connectInfo
            .tx()
            .sendContractTransaction(this.TWAMMInstantSwapContract, 'withdrawLiquidity', args, {});
    }
};
__decorate([
    (0, tool_1.EnableLogs)(),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ITWAMMInstantSwap.prototype, "addLiquidity", null);
__decorate([
    (0, tool_1.EnableLogs)(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, String, String, String, String]),
    __metadata("design:returntype", Promise)
], ITWAMMInstantSwap.prototype, "withdrawLiquidity", null);
