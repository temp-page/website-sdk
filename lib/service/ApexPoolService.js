...
let ApexPoolService = class ApexPoolService extends BaseService_1.BaseService {
    ...
    async stakeInfo(accountId, privateApi) {
        ...
        apexPoolStakeInfo.userApy = ApexPoolMathTool_1.ApexPoolMathTool.APY(apiStakeInfo.lastWeekUserReward, new bignumber_js_1.default(apiStakeInfo.apexStake.lastUserStakeAmount).plus(apiStakeInfo.esApexStake.lastUserStakeAmount).toFixed(), apexPrice.price, new bignumber_js_1.default(apiStakeInfo.avgStakeTime).div(86400).toFixed()).apy;
