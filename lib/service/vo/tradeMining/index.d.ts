...
export declare class TradeMiningSwapBalance {
    ...
    bananaAllowance: string;
    /**
     *  usdc 余额
     */
    usdcBalance: string;
    showUsdcApprove: boolean;
    showUsdcAllowance: string;
    totalSpent: string;
    currentRate: string;
    currentPrice: string;
    boostUpRate: string;
...
export declare class TradeMiningActionsHistory {
     ...
     * "out" | 'in'  transfer
     */
    action: 'claim' | 'buy' | 'sell' | 'out' | 'in' | 'redeem' | 'addLp' | 'removeLp' | 'staking' | 'unstaking' | 'claimStakingReward' | 'stakeApex' | 'unstakeApex' | 'stakeEsApex' | 'unstakeEsApex';
    banana: string;
    lpToken: string;
    usdc: string;
    apex: string;
