...
class AddressInfo {
    constructor() {
        this.successConnectInfoInstance = null;
        this.readonlyConnectInfoInstance = null;
        this.apiService = null;
    }
    readonlyConnectInfo() {
        if (this.successConnectInfoInstance != null) {
            return this.successConnectInfoInstance;
        }
    ...
    getApiService() {
        if (this.apiService == null) {
            this.apiService = new RequestService_1.RequestService(this.graphApi);
        }
