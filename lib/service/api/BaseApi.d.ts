...
export declare class BaseApi {
    ...
    bananaV2Graph<T = any, V = Variables>(query: string, variables: V): Promise<T>;
    arbiBananaGraph<T = any, V = Variables>(query: string, variables: V): Promise<T>;
    arbiDragonNftGraph<T = any, V = Variables>(query: string, variables: V): Promise<T>;
    connectInfo(): ConnectInfo;
    arbiConnectInfo(): ConnectInfo;
    address(): AddressInfo;
}
