...
exports.getBananaBurnRecord = exports.getActionsV2History = exports.getUserApexPoolStakeInfos = exports.getApexPoolStakeInfos = exports.getStakingInfo = exports.getRedeemRate = exports.getBBPData = exports.getUserActionsHistory = exports.getActionsHistory = exports.getSwapInfo = exports.getBananaApexRateLogs = void 0;
...
function getBananaBurnRecord() {
    return (0, graphql_request_1.gql) `
        query getActionsHistory {
            transferLogs(where: {token: "Banana" to:"0x0000000000000000000000000000000000000000"} orderBy:timestamp orderDirection:desc ) {
                amount
                token
                timestamp
                hash
