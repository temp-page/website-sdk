...
exports.getDragonTopUsers = exports.getDragonTransactions = exports.getBananaBurnRecord = exports.getActionsV2History = exports.getUserApexPoolStakeInfos = exports.getApexPoolStakeInfos = exports.getStakingInfo = exports.getRedeemRate = exports.getBBPData = exports.getUserActionsHistory = exports.getActionsHistory = exports.getSwapInfo = exports.getBananaApexRateLogs = void 0;
...
function getDragonTopUsers() {
    return (0, graphql_request_1.gql) `
        query getTopUsers {
            userInfos(first:10, orderDirection:desc orderBy:score where:{score_gt:0}){
                id
                score
                totalStar
                dragon
