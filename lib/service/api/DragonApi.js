...
let DragonApi = class DragonApi {
    ...
    async myNft(privateApi, connectInfo) {
        ...
        const lotteryRewardRecord = await privateApi.get(connectInfo.addressInfo.apexProBaseUrl + '/api/v2/reward/lottery-reward-record', { rewardId: '100100', token: 'usdc', ethAddress: connectInfo.account });
