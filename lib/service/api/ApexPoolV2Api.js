...
let ApexPoolV2Api = class ApexPoolV2Api {
    ...
    async stakeInfo(accountId, privateApi, connectInfo) {
        ...
        const apexPoolStakeInfo = {
            ...
            apexAllowance: new bignumber_js_1.default(apexBalance.allowance).div(10 ** apexBalance.decimals).toFixed(),
            esApexAllowance: new bignumber_js_1.default(esApexBalance.allowance).div(10 ** esApexBalance.decimals).toFixed(),
