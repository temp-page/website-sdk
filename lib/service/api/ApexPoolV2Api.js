...
let ApexPoolV2Api = class ApexPoolV2Api {
    ...
    async apexPoolAPY() {
        ...
        const totalApexStake = (0, tool_1.getValue)(apiStakeInfo, 'apexStakingApyFactor.lastTotalStakeAmount', '0');
        const totalEsApexStake = (0, tool_1.getValue)(apiStakeInfo, 'esApexStakingApyFactor.lastTotalStakeAmount', '0');
    ...
    async apexPoolStakeInfo(address, privateApi) {
        ...
        const totalApexStake = apexStake.lastTotalStakeAmount;
        const totalEsApexStake = esApexStake.lastTotalStakeAmount;
        return {
