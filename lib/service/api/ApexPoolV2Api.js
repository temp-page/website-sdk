...
let ApexPoolV2Api = class ApexPoolV2Api {
    ...
    async apexPoolStakeInfo(address, privateApi) {
        ...
        const [mainnetApexPoolStakeInfos, arbiApexPoolStakeInfos, mainnetApexPoolRegularStakeInfos, arbiApexPoolRegularStakeInfos, mantleApexPoolRegularStakeInfos, stakingUserDataResp] = await Promise.all([
            ...
            this.baseApi.graphBase(apexRegularStakingConfig.mantle.graphUrlV3, (0, gql_1.getUserApexPoolStakeInfos)(), { user: address }),
        ...
        const userRegularTotalApexStake = new bignumber_js_1.default(userMainnetRegularTotalApexStake).plus(userArbiRegularTotalApexStake).plus(userMantleRegularTotalApexStake).toFixed();
