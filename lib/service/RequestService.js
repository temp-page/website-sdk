...
let RequestService = class RequestService {
    ...
    async apexPoolStakeInfo(address, privateApi) {
        ...
        const tradingActivityFactor = (0, tool_1.getValue)(stakingUserData, 'apexStakingApyFactor.tradingActivityFactor', (0, tool_1.getValue)(stakingUserData, 'esApexStakingApyFactor.tradingActivityFactor', '') || '');
