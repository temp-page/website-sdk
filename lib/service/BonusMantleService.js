...
exports.BonusMantleService = void 0;
const BaseService_1 = require("./BaseService");
const ConnectInfo_1 = require("../ConnectInfo");
const tool_1 = require("./tool");
const vo_1 = require("./vo");
const bignumber_js_1 = __importDefault(require("bignumber.js"));
const EsAPEXMantle_1 = require("./abi/EsAPEXMantle");
/**
 * Bonus API
 */
let BonusMantleService = class BonusMantleService extends BaseService_1.BaseService {
    constructor(connectInfo) {
        super(connectInfo);
    }
    async esApexInfo() {
        const user = this.connectInfo.account;
        const esAPEX = this.connectInfo.create(EsAPEXMantle_1.EsAPEXMantle);
        console.log('esAPEX', esAPEX);
...
BonusMantleService = __decorate([
    (0, tool_1.CacheKey)('BonusMantleService'),
    __metadata("design:paramtypes", [ConnectInfo_1.ConnectInfo])
], BonusMantleService);
exports.BonusMantleService = BonusMantleService;
