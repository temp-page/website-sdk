...
exports.WalletConnect = exports.getCurrentConnect = exports.Web3Wallet = exports.ExtWallet = exports.PrivateWallet = void 0;
...
class WalletConnect {
    ...
    update() {
        ...
        if (connectInfo.status) {
            ...
            service_1.Trace.debug('connect success ', connectInfo.account, 'isArbi', connectInfo.isArbi(), 'isMantle', connectInfo.isMantle());
        }
        if (connectInfo.status) {
            connectInfo.clear();
        }
    ...
    async web3Wallet() {
        ...
        const provider = new ethers_1.ethers.providers.StaticJsonRpcProvider((0, Constant_1.getCurrentAddressInfo)().rpc, (0, Constant_1.getCurrentAddressInfo)().chainId);
        connectInfo.chainId = (await provider.getNetwork()).chainId;
        connectInfo.msg = 'success';
        connectInfo.provider = provider;
    ...
    async web3Provider() {
        ...
        if (wallet.isParticleNetwork) {
            connectInfo.account = wallet.aaAddress;
        }
        if ((0, service_1.isNullOrBlank)(connectInfo.account)) {
    ...
    async connect() {
        try {
            ...
            else if (this.wallet instanceof ExtWallet) {
                await this.extWallet();
            }
