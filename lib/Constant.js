...
async function initNetAddress(SDK_ENV) {
    ...
    addressInfo.banana = res.data.banana.address;
    addressInfo.bananaClaimable = res.data.bananaClaimable.address;
    addressInfo.apex = res.data.apex.address;
    addressInfo.usdc = res.data.usdc.address;
    addressInfo.pair = res.data.twammPair.address;
    addressInfo.twammRouter = res.data.twamm.address;
    addressInfo.buybackPool = res.data.buybackPool.address;
    addressInfo.exApex = res.data.esApex.address;
    // addressInfo.getApiService();
    // addressInfo.readonlyConnectInfo();
    currentAddressInfo = addressInfo;
    service_1.Trace.debug('INIT NODE_ENV', SDK_ENV);
