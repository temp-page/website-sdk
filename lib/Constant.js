...
function initAddressInfo(SDK_ENV) {
    ...
    if ('prod' === SDK_ENV || 'prod_dev' === SDK_ENV) {
        ...
        addressInfo.apexRegularStaking = {
            common: {
                apex: '0x52a8845df664d76c69d2eea607cd793565af42b8'.toLowerCase(),
                esApex: '0x44af87b33620c775a8363194c24ffc3067f8497c'.toLowerCase(),
                apexPoolV2: '0x634CE987dB07BA4197b6Ae9F3478A707e3D7646f'.toLowerCase(),
                apexPoolV3: '0xaf7d1a0c128d392d99c8bd4e6b880ff95e8b907b'.toLowerCase(),
            ...
            arbi: {
                apex: '0x61a1ff55c5216b636a294a07d77c6f4df10d3b56'.toLowerCase(),
                esApex: '0x0000000000000000000000000000000000000000'.toLowerCase(),
                apexPoolV2: '0xd7C402bD9F8Db724375df85701DB87bf8099cA2D'.toLowerCase(),
                apexPoolV3: '0xf51a58b02be8b6817a0d0dc8b166f88a9701b648'.toLowerCase(),
            ...
            mantle: {
                apex: '0x96630b0D78d29E7E8d87f8703dE7c14b2d5AE413',
                esApex: '0x51fCAAF4d6288f21ceDdA92f22A3C0251e8f1870',
                apexPoolV3: '0x661ea23a54dCb7dCbb533be0F50dc6EA2ECFedbB',
                graphUrlV3: 'https://mantle-mainnet-graph.pro.apex.exchange/subgraphs/name/apex/apex-pool-stake',
            },
        };
        addressInfo.apexClaimable = '';
        ...
        addressInfo.mantleRpc = 'https://rpc.sepolia.mantle.xyz';
        addressInfo.mantleChainId = 5003;
        addressInfo.mantleScan = 'https://explorer.sepolia.mantle.xyz';
        addressInfo.mantleMulticall = '0x521751c88eafdcaed9cabb4db35a1400d6933428';
        addressInfo.apexClaimable = '0x429dc47a3a6dfc6510a8ec32f9077d62eea4c1af';
        addressInfo.apexRegularStaking = {
            common: {
                ...
                apexPoolV3: '0xc2e03A885d9596657e0168F2554bF487b911B678'.toLowerCase(),
            ...
            arbi: {
                ...
                apexPoolV3: '0x89cBccEdDF07A14aFf90eF5D3A7D5BEf9e33Cb6b'.toLowerCase(),
            ...
            mantle: {
                apex: '0x7B55800de02e4799F7b00a2C9963575464053F6A',
                esApex: '0x1661181907bBbd0688EBC6B3b630b3669bBB4Bd4',
                apexPoolV3: '0x3a4d747D381D401E598CAFE65D4a70a704988c50',
                graphUrlV3: 'https://mantle-sepolia-graph.pro.apex.exchange/subgraphs/name/apex/apex-pool-stake',
            },
        };
    }
    else {
        throw new BasicException_1.BasicException(SDK_ENV + 'not support');
    }
    addressInfo.arbiAddressList = [
        addressInfo.arbiApex,
        addressInfo.arbiMulticall,
        addressInfo.arbiApexPool,
        addressInfo.dragonBall.DragonBall,
    ...
    addressInfo.mantleAddressList = [
        addressInfo.apexRegularStaking.mantle.apex,
        addressInfo.apexRegularStaking.mantle.esApex,
        addressInfo.apexRegularStaking.mantle.apexPoolV3,
    ];
 ...
 * @param apexBaseApi
 */
async function initNetAddress(SDK_ENV, _apexBaseApi = '') {
    const addressInfo = new service_1.AddressInfo();
    let apexBaseApi = _apexBaseApi;
    if (_apexBaseApi) {
        const match = _apexBaseApi.match(pattern);
        if (match.length > 0) {
            apexBaseApi = match[1] || _apexBaseApi;
        }
    }
    if ('prod' === SDK_ENV || 'prod_dev' === SDK_ENV) {
        ...
        addressInfo.bananaUsdtPair = '0x5ebfd7C625827e15C2F80fc9B5DC6224d92D400e';
        addressInfo.bananaBurnFrom = '0xD6709cc6BdFb43e31E5D959Ee1B0775923672694';
        addressInfo.mantleRpc = 'https://rpc.mantle.xyz';
        addressInfo.mantleChainId = 5000;
        addressInfo.mantleScan = 'https://explorer.mantle.xyz';
        addressInfo.mantleMulticall = '0x05f3105fc9FC531712b2570f1C6E11dD4bCf7B3c';
        addressInfo.apexClaimable = '';
        addressInfo.dragonBall = {
            DragonBallConfig: '0xEa1a853C26e2A0B9740fa43B4b19Ea777cc61622',
            DivineDragoNft: '0x104db0C0d35bcbDD26036d544c79a1e29c8Ab255',
        ...
        addressInfo.apexRegularStaking = {
            common: {
                ...
                apexPoolV2: '0x634CE987dB07BA4197b6Ae9F3478A707e3D7646f'.toLowerCase(),
                apexPoolV3: '0xaf7d1a0c128d392d99c8bd4e6b880ff95e8b907b'.toLowerCase(),
                graphUrlV2: 'https://mainnet-graph.pro.apex.exchange/subgraphs/name/apex/banana-stake-apex',
                graphUrlV3: 'https://mainnet-graph.pro.apex.exchange/subgraphs/name/apex/apex-pool-stake',
            },
            arbi: {
                apex: '0x61a1ff55c5216b636a294a07d77c6f4df10d3b56'.toLowerCase(),
                esApex: '0x0000000000000000000000000000000000000000'.toLowerCase(),
        ...
        const baseApi = (0, service_1.isNullOrBlank)(apexBaseApi) ? 'https://qa.omni.apex.exchange' : apexBaseApi;
        addressInfo.apexProBaseUrl = baseApi;
        // 非测试环境
    ...
    const config1 = await service_1.BASE_API.request(addressInfo.apexProBaseUrl + '/api/v1/mine/contracts', 'get', {});
    let config2 = {
        data: {
            contractInfoList: [],
            rpc: {
    ...
    if (!addressInfo.apexProBaseUrl.includes('pro.apex.exchange')) {
        // tslint:disable-next-line:max-line-length
        config2 = await service_1.BASE_API.request(addressInfo.apexProBaseUrl + '/api/v2/mine/contracts?token=USDT', 'get', {}).catch((e) => {
            return {
                data: {
                    contractInfoList: [],
                    rpc: {
    ...
    addressInfo.mantleEsApex = addressInfo.apexRegularStaking.mantle.esApex;
    ...
    addressInfo.apexClaimable = getConfigV2Address('apex_claimable');
    addressInfo.bananaBurnFrom = getConfigV2Address('banana_burn', '');
    addressInfo.bananaV2GraphApi = getConfigV2Address('graph_url');
    addressInfo.rpc = (0, get_1.default)((0, get_1.default)(config1, 'data.rpcs', []).find((it) => new bignumber_js_1.default(it.chainId).comparedTo(addressInfo.chainId) === 0), 'url', addressInfo.rpc);
    addressInfo.arbRpc = (0, get_1.default)((0, get_1.default)(config1, 'data.rpcs', []).find((it) => new bignumber_js_1.default(it.chainId).comparedTo(addressInfo.arbiChainId) === 0), 'url', addressInfo.arbRpc);
    addressInfo.mantleRpc = (0, get_1.default)((0, get_1.default)(config1, 'data.rpcs', []).find((it) => new bignumber_js_1.default(it.chainId).comparedTo(addressInfo.mantleChainId) === 0), 'url', addressInfo.mantleRpc);
    addressInfo.arbiAddressList = [
        addressInfo.arbiApex,
        addressInfo.arbiMulticall,
        addressInfo.arbiApexPool,
